...
void main() {
  gl_FragColor = texture2D(uTexture, vTextureCoord);
    ...
    private fun renderTextOverlay(
        ...
        // Create or recreate cache when needed
        if (mOverlayBitmapCache == null || sizeChanged) {
            ...
            // Force re-render on size change
        }

        // Re-render text only when text/size changes
        ...
        // Use cached bitmap for overlay draw
